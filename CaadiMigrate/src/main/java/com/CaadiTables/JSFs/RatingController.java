...
public class RatingController implements Serializable {
    ...
    @EJB
    private com.CaadiTables.Beans.RatingFacade ejbFacade;
    ...
    public Rating getRating(java.lang.Integer id) {
