...
public class HabilidadController implements Serializable {
    ...
    private Habilidad current;
    private DataModel items = null;
    @EJB
    private com.CaadiTables.Beans.HabilidadFacade ejbFacade;
    ...
    public Habilidad getSelected() {
        if (current == null) {
            current = new Habilidad();
            selectedItemIndex = -1;
        }
        return current;
    }

    private HabilidadFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Habilidad) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabilidadCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabilidadUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabilidadDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
