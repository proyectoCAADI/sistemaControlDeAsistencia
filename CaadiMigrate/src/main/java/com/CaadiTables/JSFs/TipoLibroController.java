...
import com.CaadiTables.Beans.TipoLibroFacade;
...
@Named("tipoLibroController")
@SessionScoped
public class TipoLibroController implements Serializable {

    private TipoLibro current;
    private DataModel items = null;
    @EJB
    private com.CaadiTables.Beans.TipoLibroFacade ejbFacade;
    ...
    public TipoLibro getSelected() {
        if (current == null) {
            current = new TipoLibro();
            selectedItemIndex = -1;
        }
        return current;
    }

    private TipoLibroFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (TipoLibro) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoLibroCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoLibroUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoLibroDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
